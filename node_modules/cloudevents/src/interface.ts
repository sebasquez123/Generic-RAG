...
export interface CloudEvent_1_0 {
  // REQUIRED Attributes
  /**
  ...
  // Other
  data?: CloudEvent_1_0_data | string | object
...
export interface CloudEvent_1_0_data {
  api?: string
  ...
  url?: string
  sequencer?: string
  storageDiagnostics?: CloudEvent_1_0_data_storageDiagnostics
}

export interface CloudEvent_1_0_data_storageDiagnostics {
  batchId: string
}

export interface CloudEvent_1_0_Transport {
  target: string
  encoding: string
}

// Export latest CE
export type CloudEvent = CloudEvent_1_0